...
**Note: For [Tokens/sec], the benchmark is general average of multiple runs of `examples\benchmark.py` resulted in. You may find different results when you test it in your own systems. 
